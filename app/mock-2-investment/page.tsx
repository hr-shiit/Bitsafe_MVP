...
const FUND_ADDRESS = "0xf31319fc36777691c3b41906688d2b486971bd89"
...
export default function Mock2Investment() {
              ...
              <CardContent className="p-8">
                <div className="flex items-start space-x-6">
                  <Avatar className="w-20 h-20">
                    ...
                    <AvatarFallback className="bg-purple-600 text-white text-2xl">M2</AvatarFallback>
                  </Avatar>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <h1 className="text-3xl font-bold text-white mb-2">Mock 2 Investment</h1>
                        <p className="text-purple-300">Managed by BitSafe Ventures</p>
                      </div>
                      <Badge className="bg-red-600/20 text-red-400 border-red-500/50">Aggressive</Badge>
                    </div>
                    <p className="text-purple-200 mb-4">
                      High-growth investment strategy targeting maximum returns through advanced trading algorithms and
                      market opportunities. Designed for investors seeking higher returns with increased risk tolerance.
                    </p>
            ...
            <Card className="bg-gray-900/50 border-purple-800/30">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-3">
                  <div className="flex items-start space-x-2">
                    ...
                    <p className="text-red-400 text-xs">
                      High Risk: This will initiate a real Ethereum transaction. Aggressive strategy may result in
                      losses.
                    </p>
                  </div>
                </div>
                ...
                <Button
                  ...
                  disabled={isInvesting || !investmentAmount || Number.parseFloat(investmentAmount) < 0.005}
